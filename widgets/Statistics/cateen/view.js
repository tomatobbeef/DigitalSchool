...
selfs=function self(){
    ...
    if(build!=0)
    {
        poda=[new Cesium.Cartesian3( -2291858.463124879,5002821.899293635,3214310.2317256955 ),new Cesium.Cartesian3( -2291661.7581554754, 5002878.811349053, 3214406.710821225 )]
