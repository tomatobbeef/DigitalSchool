...
function sear(){
    window.parent.console.log("sear2.0");
    var selectBox = document.getElementById("sel");
    var selectedValue = selectBox.options[selectBox.selectedIndex].value;
    if (selectedValue === "教室") {  
        window.parent.appk.sltj(1);
    }
    else if(selectedValue === "宿舍"){
        window.parent.appk.sltj(2);
    }
    else if(selectedValue === "学院楼"){
        window.parent.appk.sltj(3);
    }
    else if(selectedValue === "餐厅"){
        window.parent.appk.sltj(4);
    }
}
